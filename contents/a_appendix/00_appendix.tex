...
\begin{figure}[htb!]
    ...
    \label{fig:01_qualitative_evaluation_collaborative_routing}
\end{figure}
...
\begin{figure}[htb!]
    ...
    \label{fig:02_qualitative_evaluation_collaborative_algorithm}
\end{figure}

\begin{figure}[htb!]
    \centering
    \includegraphics[width=\textwidth]{contents/06_model_evaluation/02_evaluation/res/qualitativeFeedback-03_traffic_volume.pdf}
    \caption{Anzahl der jeweiligen Bewertung pro Aussage für die Erklärung zum aktuellen Verkehrsgeschehen}
    \label{fig:qualitative_evaluation_03_traffic_volume}
\end{figure}
...
\begin{figure}[htb!]
    ...
    \caption{Anzahl der jeweiligen Bewertung pro Aussage für die Erklärung zu Positionsungenauigkeiten}
    \label{fig:qualitative_evaluation_04_position_accuracy}
\end{figure}