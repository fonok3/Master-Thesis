...
Da die transportierten Informationen eine Kerneigenschaft von Erklärungen darstellen, werden in dieser Arbeit Erklärungen als Information zum Schließen des \textit{Gulf of Evaluation} \cite{norman1988psychology}.
...
Daraufhin werden diese für einen bestimmten Kontext konkretisiert, um ein besseres Verständnis dafür zu erlangen, worauf sich das Qualitätsziel in dem Anwendungsfall bezieht.
...
Diese Arbeit entwickelt zwar kein Qualitätsmodell für \textit{Explainability}, gibt allerdings Basis für die abstrakte Ebene des Modells. Im letzten Teil wendet wird diese Basis verwendet, um Anforderungen für die Integration von Erklärungen in einem spezifischen Softwaresystem aufzustellen. Welches Ziel diese Arbeit dabei verfolgt wird im nächsten Kapitel vorgestellt.
