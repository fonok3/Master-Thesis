...
Da das Geben von Erklärungen die Nutzerzufriedenheit nicht in jedem Fall erhöht, muss Hypothese 4.1 abgelehnt werden. Hypothese 4.2 muss ebenfalls abgelehnt werden, da es unter anderem einen gegenteiligen Effekt zwischen den Gruppen 3 und 4 gibt.
...
Die Analyse der Einflüsse der Erklärungen, auf die gesetzten Qualitätsziele für \textit{NUNAV Navigation} ergibt, dass die meisten Hypothesen abgelehnt werden müssen. Folglich fällt der Effekt der integrierten Erklärungen geringer aus, als zunächst erwartet. Außerdem zusammengefasst werden, dass für keine Erklärung ein signifikant negativer Einfluss im Vergleich zu keinen Erklärungen auf eine der Metriken gemessenen werden konnte.
