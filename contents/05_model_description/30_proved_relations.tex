...
\begin{itemize}
    ...
    \item Das Anzeigen einer Erklärung vor einer Situation (\textit{before}) hat einen positiveren Einfluss auf \textit{Trust}, als das Anzeigen danach \cite{haspiel_explanations_2018}.
\end{itemize}
