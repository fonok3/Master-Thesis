...
\begin{itemize}
    ...
    \item Interaktive Erlärungen haben einen positiven Einfluss auf die \textit{Perceived Transparency} eines Systems \cite{cheng2019explaining}.
\end{itemize}
...
Wenn der User mit dem Output des Systems nicht übereinstimmt, dann reduzert dies den Trust in das System. \cite{schrills_color_2020}
