...
\begin{itemize}
    ...
    \item Das Anzeigen von Erklärungen hat einen positiven Einfluss auf \textit{Trust}, \textit{wenn End User sich in unbekannten Situationen befinden} \cite{haspiel_explanations_2018}.
...
\begin{itemize}
    ...
    \item Die \textit{Explanation Goals}, mit denen Erklärungen durch Menschen formuliert werden, haben keinen Einfluss auf die vorgestellten externen Qualitätsaspekte \cite{balog_measuring_2020}.
\end{itemize}
...
Für spezifische \textit{Contexts} gibt es weitere Zusammenhänge, die eine Rolle spielen. Als Beispiele wäre hier zum Beispiel zu nennen, dass User Erklärungen im AI-Kontext... Im Recommender System Kontext wäre das...
