...
\begin{figure}[htb!]
    \begin{center}
        \includegraphics[width=0.75\textwidth]{contents/05_model_description/res/model_context_overview.pdf}
    \end{center}
